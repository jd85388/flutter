      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(emailController, 'Correo electrónico', Icons.email, keyboardType: TextInputType.emailAddress),
            const SizedBox(height: 12),
            _buildTextField(phoneController, 'Número de teléfono', Icons.phone, keyboardType: TextInputType.phone),
            const SizedBox(height: 12),
